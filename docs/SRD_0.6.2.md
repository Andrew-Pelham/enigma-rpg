...
ENIGMA System Reference Document V0.6.2, by Andrew Pelham, is licensed under the Creative Commons Attribution 4.0  with no commercial use (<https://creativecommons.org/licenses/by-nc/4.0/>).
...
The Cast is the team of player characters acting together. It is the unit that explores, fights, schemes, and suffers consequences as one. When rules affect the whole group, they target The Cast. When choices must be made under pressure, The Cast decides. In the fiction, they are a band of professionals bound by shared aims and rival obligations.
...
In Enigma there are 6 different archetypes that represent the typical characters in pulp adventure. An archetype defines the outline of your character, but by no means limits it. They help to guide you when choosing [*Equipment*](#equipment), identifying [*Knacks*](#knacks), and finding your fit in The Cast.
...
Whenever an character wants to do something that might fail, they make a [*Gamble*](#gambles). To do this, the player rolls 1d6, adding any relevant [*Bonus Dice*](#bonus-dice).

#### Success

If any die results in a 5 or 6, the action succeeds, and the player narrates what happens.

#### Blunder

If the result is a 1–4, the action fails, and the [*Director*](#the-director) describes what happens.
...
**Director:** Okay, this calls for a [*Gamble*](#gambles).
...
Once a character gains a [*Knockout*](#knockouts), their [*Peril*](#peril) resets to 0, and they are incapacitated for the rest of the current [*scene*](#scenes). The Cast will need to decide what to do with them until they recover in the next [*scene*](#scenes). [*Knockouts*](#knockouts) are permanent. If a character gains four [*Knockouts*](#knockouts), they become too weary to go on and must enter [*Retirement*](#retirement).
...
Each [*Leg*](#legs) is broken into a series of [*Scenes*](#scenes). In each [*scene*](#scenes), there is a location, a cast of characters, obstacles, and often clues about the villainous scheme. You can think of each [*scene*](#scenes) as a story beat: some bring triumphant moments for the characters, while others plunge them into danger or despair.

An [*scene*](#scenes) typically involves several [*Gambles*](#gambles) to determine the outcomes of the players' actions.

Every [*scene*](#scenes) begins with [*The Wide Shot*](#the-wide-shot), which sets the stage and paints a vivid picture of the situation. After this, the [*Director*](#the-director) asks the players what they’d like to do first.

Whether an [*scene*](#scenes) ends in victory or failure, the story must keep moving. It’s up to the [*Director*](#the-director) to introduce new paths forward—so even if the villain escapes, there's still a compelling story to tell.
...
As the [*Director*](#the-director) you will present the [*Scenes*](#scenes) and adjudicate the [*Gambles*](#gambles) made by the players. Here are some things to keep in mind while running a game:
...
This is a crucial tool for the [*Director*](#the-director) to balance the shared narration. At the start of an [*scene*](#scenes), you will initially describe the space around the characters. Then, allow each player to describe something else in their field of view their character can see. Getting into a taxi? What does each character see that makes them feel uneasy?
...
It is common for a character  to look for clues, or even more generally, get a closer look at the world around them. If the situation lends well to it or the character has sufficient skill for snooping, they can simply earn whatever information is available. If the situation is more random or the outcome isn't certain, you can ask the player to roll 1d6.

No [*Bonus Dice*](#bonus-dice), [*Peril*](#peril), or [*Lucky Saves*](#lucky-saves) apply here. Closer to 1 means less information and closer to 6 means more information. Notice how on a 1 they don't come up empty handed, the information gained is just more vague or requires a deeper look. This allows for the narrative to keep steaming forward without gatekeeping information behind a [*Gamble*](#gambles); it's just snooping as usual.
...
- When they scene the weird, strange, odd, or eldritch
- When you feel like it

### Adventuring Strain

While adventuring, characters will accumulate lots of [*Peril*](#peril). [*Peril*](#peril) is always recovered at a time and rate appropriate to the story. If The Cast forges ahead through the night, don’t let them reap the benefits of [*Resting*](#resting).
...
As The Cast moves along with their journey, they should earn rewards in a variety of ways. While not always "Holy Grails", the rewards should equal the risk involved. Here are some forms treasure might take:
...
- Allies and Connections. Having a pal in this line of business is always useful. As The Cast sufficiently helps out NPC's, you can have them return in other scenarios. These connections can also unlock new modes of travel, money-making schemes, or even inside information
...
- Their [*Peril*](#peril) resets to 0, and they are incapacitated for the rest of the [*scene*](#scenes) or [*Tumult*](#tumults).
